#!/bin/bash
# Download and cache a fixed Pyodide release into assets.
# Run this manually once, then commit assets/pyodide to the repo.
...
download_pyodide "${PYODIDE_VERSION}" "${PYODIDE_ASSETS_DIR}"
